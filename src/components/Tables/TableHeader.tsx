...
export const TableHeader: React.FC<TableHeaderProps> = ({ onAddTable }) => {
  return (
    <div className="bg-white/90 backdrop-blur-md shadow-lg border-b border-amber-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
        <div className="flex flex-col space-y-4 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
          <div className="flex items-center space-x-3">
            <div className="bg-gradient-to-r from-indigo-500 to-purple-600 p-2 sm:p-3 rounded-xl">
              <TableProperties className="h-5 w-5 sm:h-6 sm:w-6 text-white" />
            </div>
            <div>
              ...
              <p className="text-sm sm:text-base text-gray-600 mt-1">
                Manage your cafe tables and seating
              </p>
            </div>
          </div>
